...
*/
public class RunAccessExperimentNoSockets{
	
	public static void main(String[] args){
		//Create the Agent
		AgentInterface theAgent=new AccessAgent();
		
		//Create the Environment
		EnvironmentInterface theEnvironment=new AccessEnvironment();
		...
		AccessExperiment.main(args);
		System.out.println("RunAccessExperimentNoSockets Complete");
